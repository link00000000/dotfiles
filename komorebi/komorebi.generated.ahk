...
; KeePass
; If you have disabled minimize/close to tray for this application, you can delete/comment out the next line
Run, komorebic.exe identify-tray-application exe "KeePass.exe", , Hide
Run, komorebic.exe float-rule title "Log in to Pleasant Password Server", , Hide
...
; OpenVPN Connect
; If you have disabled minimize/close to tray for this application, you can delete/comment out the next line
Run, komorebic.exe identify-tray-application exe "OpenVPNConnect.exe", , Hide
...
Run, komorebic.exe float-rule title "Leave meeting", , Hide

; RingCentral (Softphone)
; If you have disabled minimize/close to tray for this application, you can delete/comment out the next line
Run, komorebic.exe identify-tray-application exe "Softphone.exe", , Hide
...
Run, komorebic.exe float-rule title "Connect to Server", , Hide
